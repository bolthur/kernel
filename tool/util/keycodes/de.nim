...
proc getAndFillKeyMapDe*(): KeyMap =
  return [
    ...
    [ uint16('a'), uint16('A'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x04
    [ uint16('b'), uint16('B'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x05
    [ uint16('c'), uint16('V'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x06
    [ uint16('d'), uint16('D'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x07
    [ uint16('e'), uint16('E'), uint16('¤'), uint16(ord(KeyNone)), ], # 0x08
    ...
    [ uint16('i'), uint16('I'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x0C
    [ uint16('j'), uint16('J'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x0D
    [ uint16('k'), uint16('K'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x0E
    [ uint16('l'), uint16('L'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x0F
    [ uint16('m'), uint16('M'), uint16('µ'), uint16(ord(KeyNone)), ], # 0x10
    [ uint16('n'), uint16('N'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x11
    [ uint16('o'), uint16('O'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x12
    [ uint16('p'), uint16('P'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x13
    [ uint16('q'), uint16('Q'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x14
    [ uint16('r'), uint16('R'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x15
    [ uint16('s'), uint16('S'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x16
    [ uint16('t'), uint16('T'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x17
    [ uint16('u'), uint16('U'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x18
    [ uint16('v'), uint16('V'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x19
    [ uint16('w'), uint16('W'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x1A
    [ uint16('x'), uint16('X'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x1B
    [ uint16('z'), uint16('Z'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x1C
    [ uint16('y'), uint16('Y'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x1D
    [ uint16('1'), uint16('!'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x1E
    [ uint16('2'), uint16('"'), uint16('²'), uint16(ord(KeyNone)), ], # 0x1F
    [ uint16('3'), uint16('§'), uint16('³'), uint16(ord(KeyNone)), ], # 0x20
    [ uint16('4'), uint16('$'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x21
    [ uint16('5'), uint16('%'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x22
    [ uint16('6'), uint16('&'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x23
    [ uint16('7'), uint16('/'), uint16('{'), uint16(ord(KeyNone)), ], # 0x24
    [ uint16('8'), uint16('('), uint16('['), uint16(ord(KeyNone)), ], # 0x25
    [ uint16('9'), uint16(')'), uint16(']'), uint16(ord(KeyNone)), ], # 0x26
    [ uint16('0'), uint16('='), uint16('}'), uint16(ord(KeyNone)), ], # 0x27
    ...
    [ uint16('ß'), uint16('?'), uint16('\\'), uint16(ord(KeyNone)), ], # 0x2D
    [ uint16('\''), uint16('`'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x2E
    [ uint16('ü'), uint16('Ü'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x2F
    [ uint16('+'), uint16('*'), uint16('~'), uint16(ord(KeyNone)), ], # 0x30
    [ uint16('#'), uint16('\''), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x31
    [ uint16(ord(KeyNone)), uint16(ord(KeyNone)), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x32
    [ uint16('ö'), uint16('Ö'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x33
    [ uint16('ä'), uint16('Ä'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x34
    [ uint16('^'), uint16('°'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x35
    [ uint16(','), uint16(';'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x36
    [ uint16('.'), uint16(':'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x37
    [ uint16('-'), uint16('_'), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x38
    ...
    [ uint16(ord(KeyDelete)), uint16(ord(KeyKP_Comma)), uint16(ord(KeyNone)), uint16(ord(KeyNone)), ], # 0x63
    [ uint16('<'), uint16('>'), uint16('|'), uint16(ord(KeyNone)), ], # 0x64
