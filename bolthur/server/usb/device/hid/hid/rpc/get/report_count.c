...
void rpc_get_report_count(
  ...
  EARLY_STARTUP_PRINT( "GET REPORT COUNT\r\n" )
  ...
  hid_get_report_count_t* message = ( hid_get_report_count_t* )request->container;
  // get device
  ...
  // push into message
  message->report_count = dev->parser_result->report_count;
