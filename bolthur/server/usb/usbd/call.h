...
int call_check_for_change( const libusb_device_t*, rpc_handler_t );
int call_child_detached( const libusb_device_t*, const libusb_device_t*, rpc_handler_t, void*, size_t, pid_t, size_t, usbd_deallocate_context_t*  );
