...
/**
 * @fn void property_add_tag(rpi_mailbox_tag_t, ...)
 ...
 */
void property_add_tag( rpi_mailbox_tag_t tag, ... ) {
  va_list vl;
  va_start( vl, tag );
...
/**
 * @fn rpi_property_t property_get*(rpi_mailbox_tag_t)
 ...
 */
rpi_property_t* property_get( rpi_mailbox_tag_t tag ) {
  // property structure for return and tag buffer
  static rpi_property_t property;
