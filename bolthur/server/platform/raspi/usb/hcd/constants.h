...
#define PERIPHERAL_USB_OFFSET_MAPPING 0U
#define PERIPHERAL_USB_CORE_OFFSET ( PERIPHERAL_USB_OFFSET_MAPPING )
#define PERIPHERAL_USB_HOST_OFFSET ( PERIPHERAL_USB_OFFSET_MAPPING + 0x400 )
#define PERIPHERAL_USB_POWER_OFFSET ( PERIPHERAL_USB_OFFSET_MAPPING + 0xE00 )
// dwhci core
