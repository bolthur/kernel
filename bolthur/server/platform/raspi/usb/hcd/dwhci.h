...
response_t dwhci_queue_add_entry( void*, uint8_t, channel_queue_entry_t** );
response_t dwhci_queue_remove_entry( channel_queue_entry_t* );
response_t dwhci_channel_send_async( uint32_t, uint32_t, libusb_transfer_error_t*, libusb_pipe_address_t*, void*, size_t, dwhci_channel_state_t, uint32_t*, void* );
