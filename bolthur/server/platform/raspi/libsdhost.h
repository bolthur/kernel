...
// command register
#define SDHOST_COMMAND_FLAG_ENABLE 0x8000
#define SDHOST_COMMAND_FLAG_FAILED 0x4000
#define SDHOST_COMMAND_FLAG_BUSY 0x800
#define SDHOST_COMMAND_FLAG_RESPONSE_NONE 0x400
#define SDHOST_COMMAND_FLAG_RESPONSE_LONG 0x200
#define SDHOST_COMMAND_FLAG_WRITE 0x80
#define SDHOST_COMMAND_FLAG_READ 0x40
#define SDHOST_COMMAND_FLAG_COMMAND_MASK 0x3F
// clock divisor
#define HC_CLOCKDIVISOR_MAXVAL 0x07FF
// host status
#define SDHOST_HOST_STATUS_HAVEDATA 0x1
#define SDHOST_HOST_STATUS_ERROR_FIFO 0x8
#define SDHOST_HOST_STATUS_ERROR_CRC7 0x10
#define SDHOST_HOST_STATUS_ERROR_CRC16 0x20
#define SDHOST_HOST_STATUS_TIMEOUT_CMD 0x40
#define SDHOST_HOST_STATUS_TIMEOUT_DATA 0x80
#define SDHOST_HOST_STATUS_INT_BLOCK 0x200
#define SDHOST_HOST_STATUS_INT_BUSY 0x400
...
// host config
#define SDHOST_HOST_CONFIG_INTBUS_WIDE 0x2
#define SDHOST_HOST_CONFIG_EXTBUS_4BIT 0x4
#define SDHOST_HOST_CONFIG_SLOW_CARD 0x8
#define SDHOST_HOST_CONFIG_INT_DATA 0x10
#define SDHOST_HOST_CONFIG_INT_BLOCK 0x100
#define SDHOST_HOST_CONFIG_INT_BUSY 0x400
// debug register
