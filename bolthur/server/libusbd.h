...
// usbd rpc
#define USBD_REGISTER_HANDLER ( GENERIC_CHILD_DETACHED + 1 )
...
#define USBD_ATTACH_ROOTHUB ( USBD_ATTACH_DEVICE + 1 )
#define USBD_GET_ROOTHUB ( USBD_ATTACH_ROOTHUB + 1 )
