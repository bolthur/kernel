...
typedef enum {
  ...
  LIBUSB_TRANSFER_ERROR_STALL = 1U << 1,
  LIBUSB_TRANSFER_ERROR_BUFFER_ERROR = 1U << 2,
  LIBUSB_TRANSFER_ERROR_BABBLE = 1U << 3,
  LIBUSB_TRANSFER_ERROR_NO_ACKNOWLEDGE = 1U << 4,
  LIBUSB_TRANSFER_ERROR_CRC_ERROR = 1U << 5,
  LIBUSB_TRANSFER_ERROR_BIT_ERROR = 1U << 6,
  LIBUSB_TRANSFER_ERROR_CONNECTION_ERROR = 1U << 7,
  LIBUSB_TRANSFER_ERROR_AHB_ERROR = 1U << 8,
  LIBUSB_TRANSFER_ERROR_NOT_YET_ERROR = 1U << 9,
  LIBUSB_TRANSFER_ERROR_TRANSACTION = 1U << 10,
  LIBUSB_TRANSFER_ERROR_DATA_TOGGLE = 1U << 11,
  LIBUSB_TRANSFER_ERROR_BUFFER_NOT_AVAILABLE = 1U << 12,
  LIBUSB_TRANSFER_ERROR_FRAME_OVERRUN = 1U << 13,
  LIBUSB_TRANSFER_ERROR_BUFFER_EXCESSIVE_TRANSMISSION = 1U << 14,
  LIBUSB_TRANSFER_ERROR_LIST_ROLLOVER = 1U << 15,
  LIBUSB_TRANSFER_ERROR_TIMEOUT = 1U << 16,
  LIBUSB_TRANSFER_ERROR_PROCESSING = 1U << 17,
