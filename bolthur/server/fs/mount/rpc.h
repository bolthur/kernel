...
void rpc_custom_handle_mount( size_t, pid_t, size_t, size_t );
void rpc_custom_handle_unmount( size_t, pid_t, size_t, size_t );
void rpc_custom_handle_auto_mount( size_t, pid_t, size_t, size_t );
