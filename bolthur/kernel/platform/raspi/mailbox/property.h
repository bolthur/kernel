...
void mailbox_property_add_tag( raspi_mailbox_tag_t, ... );
uint32_t mailbox_property_process( void );
raspi_mailbox_property_t* mailbox_property_get( raspi_mailbox_tag_t );
