...
#define SYSCALL_RPC_WAIT_FOR_CALL 34
#define SYSCALL_RPC_SET_READY 35
#define SYSCALL_RPC_END 36
#define SYSCALL_RPC_WAIT_FOR_READY 37
#define SYSCALL_RPC_CLEANUP 38
