...
#if ! defined( __KERNEL_ARCH_ARM_V7_MM_VIRT_SHORT__ )
#define __KERNEL_ARCH_ARM_V7_MM_VIRT_SHORT__

#include <kernel/mm/virt.h>

void v7_short_map( virt_context_ptr_t, vaddr_t, paddr_t, uint32_t );
void v7_short_map_random( virt_context_ptr_t, vaddr_t, uint32_t );
